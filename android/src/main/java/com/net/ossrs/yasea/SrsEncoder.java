...
public class SrsEncoder {
    ...
    public static int vPortraitWidth = 1920;
    public static int vPortraitHeight = 1080;
    public static int vLandscapeWidth = 1920;
    public static int vLandscapeHeight = 1080;
    public static int vOutWidth = 1920;   // Note: the stride of resolution must be set as 16x for hard encoding with some chip like MTK
    public static int vOutHeight = 1080;  // Since Y component is quadruple size as U and V component, the stride must be set as 32x
    public static int vBitrate = 6000 * 1024;  // 1200 kbps
    public static final int VFPS = 60;
    public static final int VGOP = 120;
    ...
    public boolean start() {
        ...
        Log.d("DEBUG SRC ENCODE",""+(VGOP / VFPS));
